    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    String nameh = snapshot.child("name").getValue(String.class);
                    String image = snapshot.child("image").getValue(String.class);

                    name.setText(nameh); // name = findViewById(R.id.nameptv);
                    Glide.with(ChatActivity.this).load(image)
                            .placeholder(R.drawable.ic_image).into(profile); // profile = findViewById(R.id.profiletv);
                }
            }

            @Override
            public void onCancelled(@NonNull DatabaseError error) {
                Log.e("ChatActivity", "Eroare la preluarea datelor utilizatorului", error.toException());
            }
        });
        ...
        send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(message)) {
                    Toast.makeText(ChatActivity.this, "Scrie ceva!", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                ref.push().setValue(hashMap)
                        .addOnSuccessListener(aVoid -> Log.d("ChatDebug", "Mesaj trimis"))
                        .addOnFailureListener(e -> Log.e("ChatDebug", "Eroare la trimitere", e));
        ...
        userquery.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren()) {
                    ...
                    name.setText(nameh);
                    try {
                        Glide.with(ChatActivity.this).load(image).placeholder(R.drawable.ic_image).into(profile);
                    } catch (Exception e) {
